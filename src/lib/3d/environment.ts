...
export default async function () {
  ...
  const bigboard = importedScene.meshes.find(({ name }) => name.match(/^bigboard\./));
  imagePortal(bigboard as Mesh, "https://net.vocsel.com:8000/file-storage/shared/bed9358a-8e8b-4251-801d-2f63691babfc-3351c169/apple-ads.jpeg");
}
